...
use self::server_messages::ComponentSyncMessage;
use bevy::prelude::*;
...
fn reliable_component_message_settings(channel: u8) -> MessageChannelSettings {
    MessageChannelSettings {
        channel,
        channel_mode: MessageChannelMode::Reliable {
            reliability_settings: ReliableChannelSettings {
...
pub fn network_channels_setup(mut net: ResMut<NetworkResource>) {
    net.set_channels_builder(|builder: &mut ConnectionChannelsBuilder| {
        ...
        builder
            ...
            .unwrap();
        builder
            .register::<ComponentSyncMessage>(reliable_component_message_settings(2))
            .unwrap();
    });
}
